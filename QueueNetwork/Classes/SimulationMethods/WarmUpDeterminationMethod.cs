...
namespace QueueNetwork {
	public class WarmUpDeterminationMethod /*: SimulationMethod*/ {
		...
		public WarmUpDeterminationMethod(int numDelaysRequired, int numReplicationsRequired, int determinationInterval, int w) {
