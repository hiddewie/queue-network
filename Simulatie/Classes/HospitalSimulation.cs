...
*/
		...
		public HospitalSimulation(
			DistributionInterface arrivalDistribution, 
			double OChance, 
			DistributionInterface OServiceDistribution, 
			DistributionInterface ORServiceDistribution, 
			DistributionInterface RServiceDistribution, 
			DistributionInterface splitDistribution, 
		 ...
		 */
		private DistributionInterface ServiceDistribution(OperationType operationType, bool eyeOK) {
			if (operationType == OperationType.OOG) {
				if (eyeOK) {
		...
		private bool ContinueOperation (OperationType operationType, OperationType serverType ) {
			...
			DistributionInterface sd = ServiceDistribution (operationType, serverType == OperationType.OOG);
